...
const Footer = () => {
  return (
    <footer className="w-full pt-[550px] md:pt-[400px] lg:pt-[200px]">
      <div className="max-w-7xl pt-24  relative  font-text md:text-sm text-xs lg:text-base">
        <div className="w-screen h-[600px] md:h-[500px] lg:h-[250px] border-t-[15px] z-30 border-secondary-brightPink absolute bottom-0 rounded-t-[60px]" />
        <div className="w-screen h-[600px] md:h-[500px] lg:h-[250px] border-t-[30px] z-20 border-complementary-crayola absolute bottom-0 rounded-t-[60px]" />
        <div className="w-screen h-[600px] md:h-[500px] lg:h-[250px] bg-text-eerieBlack absolute bottom-0 rounded-t-[60px] text-white">
