...
const Footer = () => {
  return (
    <footer className="max-w-7xl pt-24 mt-24 flex flex-center relative mx-auto font-font1">
      <div className="w-full h-[260px] bg-secondary-brightPink absolute bottom-0 rounded-t-[60px]" />
      <div className="w-full h-[250px] bg-complementary-crayola absolute bottom-0 rounded-t-[60px]" />
      <div className="w-full h-[240px] bg-text-eerieBlack absolute bottom-0 rounded-t-[60px] text-white">
        <div className="mx-6 pt-10 flex flex-col ">
          ...
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="flex flex-col">
              ...
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur unde officia
                cu
              </p>
            </div>
            {/* REDES SOCIALES */}
