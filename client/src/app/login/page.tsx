    ...
    <div className="w-screen h-screen bg-white flex items-center justify-center">
      <main className="w-[800px] h-[600px] flex items-center">
        ...
        <section className="h-[460px] w-[60%] flex flex-col items-center">
          <h1 className="font-semibold text-4xl text-primary-500 gap-18 leading-[57px]">Sign in</h1>
          <p className="w-[335px] font-light text-[12px] leading-[18px] text-normal text-center">
          ...
          >
            <input
              ...
              className="w-[335px] h-[47px] text-normal shadow-[0px_0px_6px_rgba(0,0,0,0.25)] rounded-[20px] px-[20px] py-[10px] gap-[10px] bg-white outline-none"
            />
            <input
            ...
            <button
              type="submit"
              className="w-[335px] h-[47px] rounded-[20px] px-[20px] py-[10px] gap-10 bg-primary-500 font-bold text-[16px]"
            >
              Continue
            </button>
          </form>
