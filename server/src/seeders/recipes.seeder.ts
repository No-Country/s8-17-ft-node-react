...
const recipeToSeed: Array<RecipeDto> = [
    {
        name: "Crispy Keto Potato Breakfast",
        description: "ThisDifficulty.EASYketogenic breakfast is a great way to jumpstart your day. With its crispy potatoes and rich flavors, it’s sure to leave you feeling satisfied!",
        ingredients: [
          "1 large potato",
      ...
      },
      {
        ...
        description: "Enjoy the timeless flavors of a classic Margherita pizza with this simple and delicious recipe. Perfect for pizza night!",
        ingredients: [
          "Pizza dough",
          "Tomato sauce",
      ...
      },
      {
        ...
        description: "Indulge in a creamy and flavorful pasta dish with this garlic Parmesan pasta recipe. It's simple to make and absolutely delicious!",
        ingredients: [
      ...
      },
      {
        ...
        description: "Fire up the grill and enjoy this flavorful grilled lemon herb chicken recipe. It's juicy, tender, and packed with delicious citrus and herb flavors!",
        ingredients: [
      ...
      },
      {
        ...
        description: "This refreshing and nutritious berry spinach salad is the perfect combination of sweet and savory flavors. It's packed with antioxidants and vitamins!",
        ingredients: [
